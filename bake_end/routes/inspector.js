...
router.get('/getIsnpectors',requireLogin,InspectorController.getIsnpectors)
router.post('/getIsnpectorByID/:isnpectorID',requireLogin,InspectorController.getIsnpectorByID)
