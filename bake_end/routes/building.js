...
router.get('/getBuldings',requireLogin,BuildingController.getBuldings);
router.get('/getBuildingRooms/:buildingID',BuildingController.getBuildingRooms);
router.post('/getBuldingByID/:buildingID',requireLogin,BuildingController.getBuldingByID)
